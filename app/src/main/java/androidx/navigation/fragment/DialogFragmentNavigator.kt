...
class DialogFragmentNavigator(
    ...
    open class Destination(fragmentNavigator: Navigator<out Destination>) :
        ...
        override fun onInflate(context: Context, attrs: AttributeSet) {
            ...
            context.resources.obtainAttributes(attrs, R.styleable.DialogFragmentNavigator)
                .use { array ->
                    val className =
                        array.getString(R.styleable.DialogFragmentNavigator_android_name)
